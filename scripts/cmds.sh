...
python -m scripts.generate_sample_file_map -a -i $SAMPLE_MAPPING -p $SEARCH_PATH > $MAPPING_FILE  # -a -g
...
python -m scripts.test_scripts.create_seqr_cohorts -d $PROJECT