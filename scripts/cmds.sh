...
MAPPING_FILE="${ROOT_PATH}mapping_file_wes_hg38.csv"
...
python parse_sample_file_map.py --project $PROJECT --search-path $SEARCH_PATH --allow-extra-files-in-search_path --ref $CRAM_REF  --confirm $MAPPING_FILE  
