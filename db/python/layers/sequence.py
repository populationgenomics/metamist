...
class SampleSequenceLayer(BaseLayer):
    ...
    # async def update_latest_sequence_from_sample_and_type(
    #     self,
    #     sample_id: int,
    #     sequence_type: SequenceType,
    #     status: SequenceStatus,
    ...
    #     sequence_id = await self.seqt.get_latest_sequence_id_for_sample_id_and_type(
    #         sample_id=sample_id, stype=sequence_type
    #     )
    #
    ...
    # async def upsert_latest_sequence_from_external_id_and_type(
    #     self,
    ...
    #         [external_sample_id], project=self.connection.project
    #     )
    #
    ...
    #
    #     # Get sequence_id from sample_id and batch_id
    #     return await self.update_latest_sequence_from_sample_and_type(
